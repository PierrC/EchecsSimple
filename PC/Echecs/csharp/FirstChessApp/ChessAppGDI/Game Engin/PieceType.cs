    ...
    public class PieceType
    {
        ...
        private void SetMoveSet()
        {
            ...
            else if( type == Types.KING)
            {
                ...
                moves.addMove(new Move(1, 1, false, true));
                moves.addMove(new Move(1, 0, false, true));
                moves.addMove(new Move(1, -1, false, true));
                moves.addMove(new Move(0, 1, false, true));
                moves.addMove(new Move(0, -1, false, true));
                moves.addMove(new Move(-1, 1, false, true));
                moves.addMove(new Move(-1, 0, false, true));
                moves.addMove(new Move(-1, 1, false, true));
            ...
            {
                moves = new MoveSet(null, false);
                moves.addMove(new Move(2, 1, false, true));
                moves.addMove(new Move(2, -1, false, true));
                moves.addMove(new Move(-2, 1, false, true));
                moves.addMove(new Move(-2, -1, false, true));
                moves.addMove(new Move(1, 2, false, true));
                moves.addMove(new Move(1, -2, false, true));
                moves.addMove(new Move(-1, 2, false, true));
                moves.addMove(new Move(-1, -2, false, true));
            }
            else if (type == Types.PAWN)
            {
                ...
                moves.addMove(new Move(2, 0, true, false));
                moves.addMove(new Move(1, 1, false, true));
            }
