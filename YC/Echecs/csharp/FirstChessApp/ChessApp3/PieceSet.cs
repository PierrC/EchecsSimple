    ...
    public class PieceSet :  List<Piece>
    {
        ...
        public PieceSet(Piece.PlayerColors color)
        {
            ...
            for (int i=0; i<8; i++)
            {
                ...
                Add(new Piece(Piece.Types.PAWN, color, iPos));
            }
        }
    }
}
